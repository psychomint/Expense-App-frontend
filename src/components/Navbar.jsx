...
const Navbar = () => {
  ...
  return (
    <div className='bg-gray-50'>
        <nav className='m-1 px-8 h-16 flex gap-x-4 items-center justify-between bg-[#FAFAFA] text-[#8A76FC]/80 rounded-2xl font-semibold text-lg'>
            <div className=''>
                <Link to="/">Logo</Link>
            </div>
            ...
            <div className='flex '>
                ...
                <div className="flex gap-x-6">
                    <div className='relative'>
                        ...
                        {(dropdown === 1) && 
                        <div className="hover:text-[#8A76FC] absolute left-0 rounded-lg shadow-lg border min-w-[12rem] py-2 px-4">
                            <div className=" cursor-pointer py-1 transition duration-200">
                ...
                <div className="flex gap-x-6">
                    <div className='relative'>
                        ...
                        {(dropdown === 2) && 
                        <div className="hover:text-[#8A76FC] absolute left-0 shadow-lg rounded-lg border border-gray-200 z-[9999] min-w-[12rem] py-2 px-4">
                            <div className="cursor-pointer py-1 transition duration-200">
                ...
                <div className="flex gap-x-6">
                    <div className='relative'>
                        ...
                        {(dropdown === 3) && 
                        <div className="absolute left-0 shadow-lg rounded-lg border border-gray-200 z-[9999] min-w-[12rem] py-2 px-4">
                            <div className="hover:text-[#8A76FC] cursor-pointer py-1 rounded transition duration-200">
                                Monthly Report
                            </div>
                            <div className="hover:text-[#8A76FC] cursor-pointer py-1 rounded transition duration-200">
                                By Category
